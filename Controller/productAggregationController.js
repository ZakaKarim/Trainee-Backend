...
// controllers/productAggregationController.js
...
//       {
//         $match: {
//           user: mongoose.Types.ObjectId(userId)  // Match products that belong to the userId
//         }
//       },

//       // Optional: Lookup to fetch the full details of the user for each product
//       {
//         $lookup: {
//           from: 'users',  // Name of the users collection
//           localField: 'user',  // Field in the Product model that references User
...
//       // Optional: Unwind the userDetails array to access user data
//       { $unwind: "$userDetails" },

//       // Optional: Project the fields to return the data in the required structure
//       {
//         $project: {
//           name: 1,  // Include the product name
...
//       {
//         $sort: {
//           price: 1  // Sort by price in ascending order (use -1 for descending)
//         }
//       }
//     ]);
